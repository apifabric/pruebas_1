...
resourcename="pruebas1"  # lower case, only
resourcegroup="pruebas1_rg"
...
# git clone https://github.com/apilogicserver/pruebas1.git
# cd pruebas1
...
az group create --name pruebas1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group pruebas1_rg --sku S1 --is-linux
az container create --resource-group pruebas1_rg --name pruebas1 --image apilogicserver/pruebas1:latest --dns-name-label pruebas1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//pruebas1.westus.azurecontainer.io:5656'
